        ...
        <div className="space-y-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
                <div className="flex gap-4">
                    ...
                    className="px-6 py-2 text-white rounded-lg font-semibold shadow-md hover:shadow-lg transition-all duration-200 flex items-center gap-2"
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    {editingId === todo.id ? (
                                        <input
                                            ...
                                            className="flex-1 px-3 py-1 border border-gray-200 rounded focus:outline-none focus:ring-2 focus:ring-red-500"
                                            autoFocus
                                        />
                                    ) : (
