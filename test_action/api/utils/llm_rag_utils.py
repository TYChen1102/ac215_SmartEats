...
CHROMADB_HOST = os.getenv("CHROMADB_HOST",  "llm-rag-chromadb")  # Default to localhost if not set
        ...
        if message.get("image"):
            try:
                ...
                if message.get("content"):
                    ...
                    message_parts.append("Name the food in the image, no descriptions needed")
